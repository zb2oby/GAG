	...
	<aside class="sideBar">
			<!-- <div class="icons icons-left"> -->
				...
				<div class="homeLogo"><a class="search" href="../content/accueil.php?a=<?php echo date('Y') ?>&m=<?php echo date('m') ?>&onglet=calendar"><i class="ion-home"></i></a></div>
			...
			<!-- <div class="icons icons-right"> -->
				...
				<div class="logoutLogo">
					<a href="../modules/traitementLogout.php?req=logout"><i class="ion-log-out"></i></a>
				</div>
